...
androidController.down = function (x, y, cb) {
...
androidController.getPageSource = function (cb) {
  ...
  async.series(
    [
      ...
      function (cb) {
        var cmd = this.adb.adbCmd + ' pull /storage/emulated/legacy/window_dump.xml "' + xmlFile + '"';
...
androidController.getPageSourceXML = function (cb) {
  ...
  async.series(
    [
      function (cb) {
        var cmd = this.adb.adbCmd + ' shell uiautomator dump /storage/emulated/legacy/window_dump.xml';
